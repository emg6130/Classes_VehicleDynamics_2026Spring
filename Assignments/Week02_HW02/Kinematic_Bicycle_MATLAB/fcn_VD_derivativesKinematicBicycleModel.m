function dydt = fcn_VD_derivativesKinematicBicycleModel( y, FrontSteeringRadians, U, varargin)
...
% FORMAT:
%
%      dydt = fcn_VD_derivativesKinematicBicycleModel( y, FrontSteeringRadians, U, (figNum))
%
% INPUTS:
%
