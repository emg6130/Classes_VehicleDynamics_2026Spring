% script_test_fcn_VD_kinematicBicycleRK4.m
% tests fcn_VD_kinematicBicycleRK4.m

% REVISION HISTORY:
%
% 2026_01_31 by Sean Brennan, sbrennan@psu.edu
% - In script_test_fcn_VD_kinematicBicycleRK4
...
indexTwoSeconds = find(t >= 2, 1); % first instance after two seconds
stateTrajectory(indexTwoSeconds,:)
