function dydt = fcn_VD_derivativesKinematicPointMassModel( y, frontSteeringRadians, U, varargin)
...
% FORMAT:
%
%      dydt = fcn_VD_derivativesKinematicPointMassModel( y, frontSteeringRadians, U, (figNum))
%
% INPUTS:
%
...
%         to Y axis
%
%      frontSteeringRadians: the rate of change of the yaw angle of the vehicle (input: rad/sec)
%
...
if 0==flag_max_speed
    if flag_check_inputs
        ...
        % Check the frontSteeringRadians input to be sure it has 1 column and 1 row
        fcn_DebugTools_checkInputsToFunctions(frontSteeringRadians, '1column_of_numbers',[1 1]);
...
%% Pose dynamics
L = 2.75;
DposeDt = U/L*tan(frontSteeringRadians);
...
if flag_do_plots
	...
	rotationAngle = frontSteeringRadians;
