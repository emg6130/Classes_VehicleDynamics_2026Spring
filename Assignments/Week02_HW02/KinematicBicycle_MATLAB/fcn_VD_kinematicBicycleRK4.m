function [stateTrajectory, t, steeringUsed] = fcn_VD_kinematicBicycleRK4(initialStates, deltaT, timeInterval, steeringAndTimeInputs, U, varargin)

%% fcn_VD_kinematicBicycleRK4
%   Simulates the point-mass kinematic model using Runga Kutta 4th-order
%
% FORMAT:
%
%      [stateTrajectory, t, steeringUsed] =
%      fcn_VD_kinematicBicycleRK4(initialStates, deltaT,
...
%      fcn_VD_kinematicBicycle
%
% EXAMPLES:
%
%     See the script: script_test_fcn_VD_kinematicBicycleRK4
...
% REVISION HISTORY:
%
% As: fcn_VD_kinematicBicycle
%
% 2026_01_26 by Sean Brennan, sbrennan@psu.edu
% - First write of fcn_VD_kinematicBicycleRK4 function
%
% As: fcn_VD_kinematicBicycleRK4
%
% 2026_01_31 by Sean Brennan, sbrennan@psu.edu
% - In fcn_VD_kinematicBicycleRK4
...
for ith_time = 1:N_timeSteps
	...
	[~, y] = fcn_VD_RungeKutta(...
		@(t,y) fcn_VD_derivativesKinematicBicycle(y,inputOmega, U, -1), ...
